...
from films.views import index, movies, movie, persons, person, delete_person, genres, delete_genre, movie_genre_add, movie_person_add, movie_person_remove, movie_genre_remove
...
urlpatterns = [
    ...
    path('movie-genre-remove/<int:movie_id>/<int:genre_id>', movie_genre_remove, name = 'movie_genre_remove'),
    path('movie-person-add/<int:movie_id>', movie_person_add, name = 'movie_person_add'),
    path('movie-person-remove/<int:movie_id>/<int:person_id>/', movie_person_remove, name = 'movie_person_remove'),
