...
from films.views import (delete_genre, delete_person, genres, index, movie,
                         movie_genre_add, movie_genre_remove, movie_person_add,
                         movie_person_remove, movies, person, persons)
